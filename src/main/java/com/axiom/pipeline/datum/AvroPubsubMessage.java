...
/**
 * The {@link AvroPubsubMessage} class is an Avro wrapper class for {@link
...
public class AvroPubsubMessage {
  ...
  private AvroPubsubMessage() {}

  public AvroPubsubMessage(byte[] message, Map<String, String> attributes) {
    this.message = message;
    this.attributes = attributes;
  }

  public AvroPubsubMessage(byte[] message, Map<String, String> attributes, long timestamp) {
    this.message = message;
    this.attributes = attributes;
  ...
  public boolean equals(Object obj) {
    ...
    final AvroPubsubMessage other = (AvroPubsubMessage) obj;
